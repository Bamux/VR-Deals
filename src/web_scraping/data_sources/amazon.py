...
def get_amazon_offers(store_id):
    ...
    article_name_list = []
    urls = [
        "https://www.amazon.de/s?k=vr+brille",
    ...
    for url in urls:
        ...
        max_page_number = max_page_number.find_all('li', class_='a-disabled')
        if len(max_page_number) > 1:
            max_page_number = int(max_page_number[1].text)
        else:
            max_page_number = 3
