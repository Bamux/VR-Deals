...
-- Exportiere Struktur von Tabelle vr_dealz.articles
...
-- Exportiere Daten aus Tabelle vr_dealz.articles: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle vr_dealz.headsets: ~4 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle vr_dealz.stores
...
-- Exportiere Daten aus Tabelle vr_dealz.stores: ~2 rows (ungefähr)
DELETE FROM `stores`;
